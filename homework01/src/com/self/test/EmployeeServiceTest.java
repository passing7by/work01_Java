...
public class EmployeeServiceTest {
	public static void main(String[] args) {
		...
		//1. Service 객체를 생성
		EmployeeService service = EmployeeService.getInstance(10);
		...
		System.out.println("\n============ 2. deleteEngineer(EEE 삭제) ============ ");
		service.deleteEngineer("EEE");
		System.out.println("============ Engineer 정보확인 ============ ");
		service.printEngineers();
		
		System.out.println("\n============ 3. updateManager(CCC 연봉 수정 200->350) ============ ");
		service.updateManager(3500000.0,"부",4,"CCC");
		...
		System.out.println("============ 인턴 Manager 등록 ============ ");
		service.addManager("Jiyeon", new MyDate(2000,1,27), 200.0);
		service.printManagers();
